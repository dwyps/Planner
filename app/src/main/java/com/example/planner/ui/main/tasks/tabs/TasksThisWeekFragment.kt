...
@AndroidEntryPoint
class TasksThisWeekFragment : Fragment(R.layout.tasks_recycler_view_fragment), TasksTaskRecyclerAdapter.OnItemListener {
    ...
    private fun initRecyclerView() {
        ...
        tasks_recycler_view.apply {
            ...
            taskRecyclerAdapter = TasksTaskRecyclerAdapter(this@TasksThisWeekFragment)
            ...
            when(it.status) {
                ...
                Resource.Status.SUCCESS -> {
                    ...
                    if(it.data != null) {
                        ...
                        taskRecyclerAdapter.submitList(tasksViewModel.getThisWeekTasks(it.data))

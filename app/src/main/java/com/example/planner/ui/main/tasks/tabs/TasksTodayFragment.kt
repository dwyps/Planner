...
@AndroidEntryPoint
class TasksTodayFragment : Fragment(R.layout.tasks_recycler_view_fragment), TasksTaskRecyclerAdapter.OnItemListener {
    ...
    private fun initRecyclerView() {
        ...
        tasks_recycler_view.apply {
            ...
            taskRecyclerAdapter = TasksTaskRecyclerAdapter(this@TasksTodayFragment)
            ...
            when(it.status) {
                ...
                Resource.Status.SUCCESS -> {
                    ...
                    if(it.data != null) {
                        ...
                        taskRecyclerAdapter.submitList(tasksViewModel.getTodayTasks(it.data))
